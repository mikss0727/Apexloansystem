                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-body">
                      <div class="row" style="margin-bottom: 10px;">
                          ...
                          <button class="btn btn-primary" id="addRate"><i class="fa fa-plus"></i> Add Rate</button>     
                    ...
                    <!-- ADD FORM -->
                    <div class="card"  id="add_rate" style="display:none">
                      <div class="card-header pb-0">
                          <h5>Add New Rate</h5>
                      </div>
                      <form class="needs-validation" id="addRate_form" novalidate="">
                          <div class="card-body">
                              <div class="row">
                                  <div class="col">
                                      <div class="mb-3">
                                          <label class="form-label" for="add_rateID">Rate ID <span style="color: red;">*</span></label>
                                          <input class="form-control" id="add_rateID" name="add_rateID" type="text" required="">
                                          <div class="valid-feedback">Looks good!</div>
                                          <div class="invalid-feedback">Please input a Rate ID.</div>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col">
                                      <div class="mb-3">
                                          <label class="form-label" for="add_rateName">Rate Name <span style="color: red;">*</span></label>
                                          <input class="form-control" id="add_rateName" name="add_rateName" type="text" required="">
                                          <div class="valid-feedback">Looks good!</div>
                                          <div class="invalid-feedback">Please input a Rate Name.</div>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                          ...
                          <input value="addRate" name="process" type="hidden">
                     ...
                     <!-- EDIT FORM -->
                    <div class="card"  id="edit_rateForm" style="display:none">
                        <div class="card-header pb-0">
                            <h5>Edit Rate</h5>
                        </div>
                        <form  class="needs-validation" novalidate="" id="rateEdit_form">
                            <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <div class="mb-3">
