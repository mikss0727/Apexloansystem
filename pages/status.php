                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-body">
                      <div class="row" style="margin-bottom: 10px;">
                          ...
                          <button class="btn btn-primary" id="addStatus"><i class="fa fa-plus"></i> Add Status</button>     
                    ...
                    <!-- ADD FORM -->
                    <div class="card"  id="add_status" style="display:none">
                      <div class="card-header pb-0">
                          <h5>Add New Status</h5>
                      </div>
                      <form class="needs-validation" id="addStatus_form" novalidate="">
                          <div class="card-body">
                              <div class="row">
                                  <div class="col">
                                      <div class="mb-3">
                                          <label class="form-label" for="add_statusID">Status ID <span style="color: red;">*</span></label>
                                          <input class="form-control" id="add_statusID" name="add_statusID" type="text" required="">
                                          <div class="valid-feedback">Looks good!</div>
                                          <div class="invalid-feedback">Please input a Status ID.</div>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col">
                                      <div class="mb-3">
                                          <label class="form-label" for="add_statusName">Status Name <span style="color: red;">*</span></label>
                                          <input class="form-control" id="add_statusName" name="add_statusName" type="text" required="">
                                          <div class="valid-feedback">Looks good!</div>
                                          <div class="invalid-feedback">Please input a Status Name.</div>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                          ...
                          <input value="addStatus" name="process" type="hidden">
                     ...
                     <!-- EDIT FORM -->
                    <div class="card"  id="edit_status" style="display:none">
                        <div class="card-header pb-0">
                            <h5>Edit Status</h5>
                        </div>
                        <form  class="needs-validation" novalidate="" id="statusEdit_form">
                            <div class="card-body">
                            <div class="row">
                                <div class="col">
                                <div class="mb-3">
...
<script src="js/status-js.js"></script>
