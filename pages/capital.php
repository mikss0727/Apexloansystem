            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        ...
                        <button class="btn btn-primary" id="addCapital"><i class="fa fa-plus"></i> Add New Capital</button>     
                        ...
                        <table class="display" id="basic-1">
                            ...
                            <?php
                                ...
                                ?>
                                <tr>
                                    <td> <?php echo $row["CapitalInvestments"]; ?></td>
                                    <td><?php 
                                            if($row["CreatedOn"] == '' || $row["CreatedOn"] == null)
                                            {
                                                echo '';
                                            }
                                            else{
                     ...
                     <!-- ADD FORM -->
                    <div class="card"  id="add_capital" style="display:none">
                    <div class="card-header pb-0">
                        <h5>Add New Capital</h5>
                    </div>
                    <form class="needs-validation" id="addCapital_form" novalidate="">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="add_capitalID">Capital Investment <span style="color: red;">*</span></label>
                                        <input class="form-control" id="add_capitalID" name="add_capitalID" type="text" required="">
                        ...
                        <input value="addCapital" name="process" type="hidden">
