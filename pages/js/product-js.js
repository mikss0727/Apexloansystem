            ...
            if(data.length <= 0){
              ...
              $('#basic-1').DataTable({
            	...
            	},
                {
                    ...
                    {
                      "data": function(item) {
                        return '<a class="btn btn-pill btn-outline-primary btn-xs" id="editProduct" data-toggle="modal" data-pk_id="' + item.id + '" data-product_id="' + item.ProductID + '" data-product_name="' + item.ProductName + '" data-loan_amount="' + item.LoanAmount + '"  data-term="' + item.TermID + '" data-isactive="' + item.isActive + '"> <i class="fa fa-edit" data-toggle="tooltip"  title="Edit"></i></a>  <a href="#" class="btn btn-pill btn-outline-danger btn-xs" id="deleteProduct" data-pk_id="' + item.id + '" data-product_id="' + item.ProductID + '"><i class="fa fa-trash-o" data-toggle="tooltip" title="Delete"></i></a>';
...
document.addEventListener('DOMContentLoaded', function() {
	...
	$(document).on('click','#editProduct',function(e) {
		...
		var edit_term=$(this).attr("data-term");
	...
	$("#addProduct_form").submit(function(e) {
		...
		const form = document.getElementById("addProduct_form");
	...
	$("#productEdit_form").submit(function(e) {
		...
		const form = document.getElementById("productEdit_form");
