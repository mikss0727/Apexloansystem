            ...
            if(data.length <= 0){
              ...
              $('#basic-1').DataTable({
            	...
            	},
                {
                    ...
                    {
                      "data": function(item) {
                        return '<a class="btn btn-pill btn-outline-primary btn-xs" id="editPosition" data-toggle="modal" data-pk_id="' + item.id + '" data-pos_id="' + item.PositionID + '" data-pos_name="' + item.PositionName + '" data-isactive="' + item.isActive + '"><i class="fa fa-edit" data-toggle="tooltip" title="Edit"></i></a>  <a href="#" class="btn btn-pill btn-outline-danger btn-xs" id="deletePosition" data-pk_id="' + item.id + ' "data-pos_id="' + item.PositionID + '"><i class="fa fa-trash-o" data-toggle="tooltip" title="Delete"></i></a>';
...
document.addEventListener('DOMContentLoaded', function() {
	...
	$("#addPosition_form").submit(function(e) {
		...
		const form = document.getElementById("addPosition_form");
	...
	$("#positionEdit_form").submit(function(e) {
		...
		const form = document.getElementById("positionEdit_form");
